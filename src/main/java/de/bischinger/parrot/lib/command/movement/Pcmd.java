...
import static de.bischinger.parrot.lib.command.ChannelType.JUMPINGSUMO_CONTROLLER_TO_DEVICE_NONACK_ID;
import static de.bischinger.parrot.lib.command.FrameType.ARNETWORKAL_FRAME_TYPE_DATA;
